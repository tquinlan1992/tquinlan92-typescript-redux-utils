...
export declare function createReducer<StateType>(
  initialState: StateType,
  actions: ActionCreatorWithReducerGroup<StateType>
): (
  state: StateType | undefined,
  incomingAction: Action<AnyAction>
) => StateType;
export interface StateTypeReducer<StateType, ActionParams> {
  (state: StateType, action: ActionParams): StateType;
}
export declare function makeActionCreatorWithReducer<StateType, ActionParams>(
  name: string,
...
export declare function getActionCreator<AppState>(): <ActionParams>(
  name: string,
...
export declare function getActionCreatorWithImmer<AppState>(): <ActionParams>(
  name: string,
  reducer: (appState: AppState, actionParams: ActionParams) => undefined | void
) => {
  actionCreator: ActionCreator<ActionParams>;
  reducer: StateTypeReducer<AppState, ActionParams>;
};
export declare function getCreators<
  T extends {
...
export declare function makeActionCreatorWithReducerWithPrefix<
  StateType,
  ActionParams
>(
  actionName: string,
...
export declare function getReducersFromCombinedActionReducer<
  T extends {
...
export declare function getActionsFromCombinedActionReducer<
  T extends {
    [key: string]: ActionsAndReducer;
  }
>(
...
export interface ActionsReducersFromCombinedActionReducer<
  ActionsReducersInstances extends ActionsAndReducerSetup
> {
  actions: {
...
export declare function getActionsAndReducersFromCombinedActionReducer<
  Creators extends ActionsAndReducerSetup
>(creators: Creators): ActionsReducersFromCombinedActionReducer<Creators>;
export declare function testRunner<ReducerState>(
  reducer: Reducer
): (initalState: ReducerState, action: AnyAction) => any;
...
export declare function makeSimpleReducer<State extends {}>(
  reducerName: string,
  initialState: State,
  otherActions?: OtherActions<State>
): {
  actions: {
    [P in keyof ({
      [P in keyof State]: {
...
declare type AppStateWithActions<
...
export type ActionsForState<State> = {
  [P: string]: (
    state: Omit<State, "actions">,
    actionParams: any
  ) => undefined | void;
};

export type ActionsForStateWithActions<
  State extends { actions: ActionsForState<State> }
> = {
  [P in keyof State["actions"]]: (
    state: Omit<State, "actions">,
    actionParams: any
  ) => undefined | void;
} & {
...
>(
  ...
  actions: {
    [P in keyof State]: {
      [A in keyof State[P]["state"]]: ActionCreator<State[P]["state"][A]>;
    } & {
      ...
      set: ActionCreator<Partial<State[P]["state"]>>;
        ...
        [A in keyof State[P]["actions"]]: ActionCreator<
          Parameters<State[P]["actions"][A]>[1]
        >;
      };
  };
  ...
  selectors: {
    [P in keyof State]: {
      [A in keyof State[P]["state"]]: (
        state: NestedStatePick<State>
      ) => State[P]["state"][A];
    };
  };
